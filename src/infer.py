...
def infer_to_output(model_name, filename, output_name):

    predictions = infer(model_name, filename)
...
if __name__ == '__main__':
    infer_to_output(sys.argv[1], sys.argv[2], sys.argv[3])